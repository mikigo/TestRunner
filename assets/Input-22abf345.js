...
`,[l("input, textarea",`
 ...
 `),F("&:-webkit-autofill ~",[l("placeholder","display: none;")])]),k("round",[X("textarea","border-radius: calc(var(--n-height) / 2);")]),l("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),k("textarea",[l("placeholder","overflow: visible;")]),X("autosize","width: 100%;"),k("autosize",[l("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `)]),F("&:hover",[l("state-border","border: var(--n-border-hover);")]),k("focus","background-color: var(--n-color-focus);",[l("state-border",`
 ...
 `),["warning","error"].map(t=>k(`${t}-status`,[X("disabled",[y("base-loading",`
 ...
 box-shadow: var(--n-box-shadow-focus-${t});
 border: var(--n-border-focus-${t});
 `)])])]))]),Co=y("input",[k("disabled",[l("input-el, textarea-el",`
 -webkit-text-fill-color: var(--n-text-color-disabled);
 `)])]);function Po(t){let c=0;for(const s of t)c++;return c}function re(t){return t===""||t==null}function So(t){const c=P(null);function s(){const{value:f}=t;if(!(f!=null&&f.focus)){x();return}const{selectionStart:d,selectionEnd:o,value:w}=f;if(d==null||o==null){x();return}c.value={start:d,end:o,beforeText:w.slice(0,d),afterText:w.slice(o)}}function v(){var f;const{value:d}=c,{value:o}=t;if(!d||!o)return;const{value:w}=o,{start:R,beforeText:m,afterText:M}=d;let z=w.length;if(w.endsWith(M))z=w.length-M.length;else if(w.startsWith(m))z=m.length;else{const b=m[R-1],i=w.indexOf(b,R-1);i!==-1&&(z=i+1)}(f=o.setSelectionRange)===null||f===void 0||f.call(o,z,z)}function x(){c.value=null}return ge(t,x),{recordCursor:s,restoreCursor:v}}const Te=$({name:"InputWordCount",setup(t,{slots:c}){const{mergedValueRef:s,maxlengthRef:v,mergedClsPrefixRef:x,countGraphemesRef:f}=ke(Re),d=_(()=>{const{value:o}=s;return o===null||Array.isArray(o)?0:(f.value||Po)(o)});return()=>{const{value:o}=v,{value:w}=s;return r("span",{class:`${x.value}-input-word-count`},bn(c.default,{value:w===null||Array.isArray(w)?"":w},()=>[o===void 0?d.value:`${d.value} / ${o}`]))}}}),Mo=Object.assign(Object.assign({},De.props),{bordered:{type:Boolean,default:void 0},type:{type:String,default:"text"},placeholder:[Array,String],defaultValue:{type:[String,Array],default:null},value:[String,Array],disabled:{type:Boolean,default:void 0},size:String,rows:{type:[Number,String],default:3},round:Boolean,minlength:[String,Number],maxlength:[String,Number],clearable:Boolean,autosize:{type:[Boolean,Object],default:!1},pair:Boolean,separator:String,readonly:{type:[String,Boolean],default:!1},passivelyActivated:Boolean,showPasswordOn:String,stateful:{type:Boolean,default:!0},autofocus:Boolean,inputProps:Object,resizable:{type:Boolean,default:!0},showCount:Boolean,loading:{type:Boolean,default:void 0},allowInput:Function,renderCount:Function,onMousedown:Function,onKeydown:Function,onKeyup:[Function,Array],onInput:[Function,Array],onFocus:[Function,Array],onBlur:[Function,Array],onClick:[Function,Array],onChange:[Function,Array],onClear:[Function,Array],countGraphemes:Function,status:String,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],textDecoration:[String,Array],attrSize:{type:Number,default:20},onInputBlur:[Function,Array],onInputFocus:[Function,Array],onDeactivate:[Function,Array],onActivate:[Function,Array],onWrapperFocus:[Function,Array],onWrapperBlur:[Function,Array],internalDeactivateOnEnter:Boolean,internalForceFocus:Boolean,internalLoadingBeforeSuffix:{type:Boolean,default:!0},showPasswordToggle:Boolean}),Fo=$({name:"Input",props:Mo,slots:Object,setup(t){const{mergedClsPrefixRef:c,mergedBorderedRef:s,inlineThemeDisabled:v,mergedRtlRef:x}=yn(t),f=De("Input","-input",xo,Dn,t,c);wn&&_e("-input-safari",Co,c);const d=P(null),o=P(null),w=P(null),R=P(null),m=P(null),M=P(null),z=P(null),b=So(z),i=P(null),{localeRef:p}=vo("Input"),C=P(t.defaultValue),A=me(t,"value"),T=xn(A,C),N=Cn(t),{mergedSizeRef:ie,mergedDisabledRef:I,mergedStatusRef:Be}=N,L=P(!1),O=P(!1),D=P(!1),j=P(!1);let le=null;const se=_(()=>{const{placeholder:e,pair:n}=t;return n?Array.isArray(e)?e:e===void 0?["",""]:[e,e]:e===void 0?[p.value.placeholder]:[e]}),Ee=_(()=>{const{value:e}=D,{value:n}=T,{value:a}=se;return!e&&(re(n)||Array.isArray(n)&&re(n[0]))&&a[0]}),We=_(()=>{const{value:e}=D,{value:n}=T,{value:a}=se;return!e&&a[1]&&(re(n)||Array.isArray(n)&&re(n[1]))}),ce=Se(()=>t.internalForceFocus||L.value),$e=Se(()=>{if(I.value||t.readonly||!t.clearable||!ce.value&&!O.value)return!1;const{value:e}=T,{value:n}=ce;return t.pair?!!(Array.isArray(e)&&(e[0]||e[1]))&&(O.value||n):!!e&&(O.value||n)}),de=_(()=>{const{showPasswordOn:e}=t;if(e)return e;if(t.showPasswordToggle)return"click"}),H=P(!1),Ie=_(()=>{const{textDecoration:e}=t;return e?Array.isArray(e)?e.map(n=>({textDecoration:n})):[{textDecoration:e}]:["",""]}),ye=P(void 0),Le=()=>{var e,n;if(t.type==="textarea"){const{autosize:a}=t;if(a&&(ye.value=(n=(e=i.value)===null||e===void 0?void 0:e.$el)===null||n===void 0?void 0:n.offsetWidth),!o.value||typeof a=="boolean")return;const{paddingTop:h,paddingBottom:g,lineHeight:u}=window.getComputedStyle(o.value),B=Number(h.slice(0,-2)),E=Number(g.slice(0,-2)),W=Number(u.slice(0,-2)),{value:U}=w;if(!U)return;if(a.minRows){const K=Math.max(a.minRows,1),fe=`${B+E+W*K}px`;U.style.minHeight=fe}if(a.maxRows){const K=`${B+E+W*a.maxRows}px`;U.style.maxHeight=K}}},Ve=_(()=>{const{maxlength:e}=t;return e===void 0?void 0:Number(e)});Pn(()=>{const{value:e}=T;Array.isArray(e)||he(e)});const Ne=Sn().proxy;function Z(e,n){const{onUpdateValue:a,"onUpdate:value":h,onInput:g}=t,{nTriggerFormInput:u}=N;a&&S(a,e,n),h&&S(h,e,n),g&&S(g,e,n),C.value=e,u()}function G(e,n){const{onChange:a}=t,{nTriggerFormChange:h}=N;a&&S(a,e,n),C.value=e,h()}function Oe(e){const{onBlur:n}=t,{nTriggerFormBlur:a}=N;n&&S(n,e),a()}function je(e){const{onFocus:n}=t,{nTriggerFormFocus:a}=N;n&&S(n,e),a()}function He(e){const{onClear:n}=t;n&&S(n,e)}function Ue(e){const{onInputBlur:n}=t;n&&S(n,e)}function Ke(e){const{onInputFocus:n}=t;n&&S(n,e)}function qe(){const{onDeactivate:e}=t;e&&S(e)}function Ye(){const{onActivate:e}=t;e&&S(e)}function Xe(e){const{onClick:n}=t;n&&S(n,e)}function Je(e){const{onWrapperFocus:n}=t;n&&S(n,e)}function Ze(e){const{onWrapperBlur:n}=t;n&&S(n,e)}function Ge(){D.value=!0}function Qe(e){D.value=!1,e.target===M.value?Q(e,1):Q(e,0)}function Q(e,n=0,a="input"){const h=e.target.value;if(he(h),e instanceof InputEvent&&!e.isComposing&&(D.value=!1),t.type==="textarea"){const{value:u}=i;u&&u.syncUnifiedContainer()}if(le=h,D.value)return;b.recordCursor();const g=et(h);if(g)if(!t.pair)a==="input"?Z(h,{source:n}):G(h,{source:n});else{let{value:u}=T;Array.isArray(u)?u=[u[0],u[1]]:u=["",""],u[n]=h,a==="input"?Z(u,{source:n}):G(u,{source:n})}Ne.$forceUpdate(),g||ze(b.restoreCursor)}function et(e){const{countGraphemes:n,maxlength:a,minlength:h}=t;if(n){let u;if(a!==void 0&&(u===void 0&&(u=n(e)),u>Number(a))||h!==void 0&&(u===void 0&&(u=n(e)),u<Number(a)))return!1}const{allowInput:g}=t;return typeof g=="function"?g(e):!0}function tt(e){Ue(e),e.relatedTarget===d.value&&qe(),e.relatedTarget!==null&&(e.relatedTarget===m.value||e.relatedTarget===M.value||e.relatedTarget===o.value)||(j.value=!1),ee(e,"blur"),z.value=null}function nt(e,n){Ke(e),L.value=!0,j.value=!0,Ye(),ee(e,"focus"),n===0?z.value=m.value:n===1?z.value=M.value:n===2&&(z.value=o.value)}function ot(e){t.passivelyActivated&&(Ze(e),ee(e,"blur"))}function rt(e){t.passivelyActivated&&(L.value=!0,Je(e),ee(e,"focus"))}function ee(e,n){e.relatedTarget!==null&&(e.relatedTarget===m.value||e.relatedTarget===M.value||e.relatedTarget===o.value||e.relatedTarget===d.value)||(n==="focus"?(je(e),L.value=!0):n==="blur"&&(Oe(e),L.value=!1))}function at(e,n){Q(e,n,"change")}function it(e){Xe(e)}function lt(e){He(e),we()}function we(){t.pair?(Z(["",""],{source:"clear"}),G(["",""],{source:"clear"})):(Z("",{source:"clear"}),G("",{source:"clear"}))}function st(e){const{onMousedown:n}=t;n&&n(e);const{tagName:a}=e.target;if(a!=="INPUT"&&a!=="TEXTAREA"){if(t.resizable){const{value:h}=d;if(h){const{left:g,top:u,width:B,height:E}=h.getBoundingClientRect(),W=14;if(g+B-W<e.clientX&&e.clientX<g+B&&u+E-W<e.clientY&&e.clientY<u+E)return}}e.preventDefault(),L.value||xe()}}function ct(){var e;O.value=!0,t.type==="textarea"&&((e=i.value)===null||e===void 0||e.handleMouseEnterWrapper())}function dt(){var e;O.value=!1,t.type==="textarea"&&((e=i.value)===null||e===void 0||e.handleMouseLeaveWrapper())}function ut(){I.value||de.value==="click"&&(H.value=!H.value)}function ht(e){if(I.value)return;e.preventDefault();const n=h=>{h.preventDefault(),Ae("mouseup",document,n)};if(Fe("mouseup",document,n),de.value!=="mousedown")return;H.value=!0;const a=()=>{H.value=!1,Ae("mouseup",document,a)};Fe("mouseup",document,a)}function ft(e){t.onKeyup&&S(t.onKeyup,e)}function vt(e){switch(t.onKeydown&&S(t.onKeydown,e),e.key){case"Escape":ue();break;case"Enter":pt(e);break}}function pt(e){var n,a;if(t.passivelyActivated){const{value:h}=j;if(h){t.internalDeactivateOnEnter&&ue();return}e.preventDefault(),t.type==="textarea"?(n=o.value)===null||n===void 0||n.focus():(a=m.value)===null||a===void 0||a.focus()}}function ue(){t.passivelyActivated&&(j.value=!1,ze(()=>{var e;(e=d.value)===null||e===void 0||e.focus()}))}function xe(){var e,n,a;I.value||(t.passivelyActivated?(e=d.value)===null||e===void 0||e.focus():((n=o.value)===null||n===void 0||n.focus(),(a=m.value)===null||a===void 0||a.focus()))}function mt(){var e;!((e=d.value)===null||e===void 0)&&e.contains(document.activeElement)&&document.activeElement.blur()}function gt(){var e,n;(e=o.value)===null||e===void 0||e.select(),(n=m.value)===null||n===void 0||n.select()}function bt(){I.value||(o.value?o.value.focus():m.value&&m.value.focus())}function yt(){const{value:e}=d;e!=null&&e.contains(document.activeElement)&&e!==document.activeElement&&ue()}function wt(e){if(t.type==="textarea"){const{value:n}=o;n==null||n.scrollTo(e)}else{const{value:n}=m;n==null||n.scrollTo(e)}}function he(e){const{type:n,pair:a,autosize:h}=t;if(!a&&h)if(n==="textarea"){const{value:g}=w;g&&(g.textContent=`${e!=null?e:""}\r
`)}else{const{value:g}=R;g&&(e?g.textContent=e:g.innerHTML="&nbsp;")}}function xt(){Le()}const Ce=P({top:"0"});function Ct(e){var n;const{scrollTop:a}=e.target;Ce.value.top=`${-a}px`,(n=i.value)===null||n===void 0||n.syncUnifiedContainer()}let te=null;Me(()=>{const{autosize:e,type:n}=t;e&&n==="textarea"?te=ge(T,a=>{!Array.isArray(a)&&a!==le&&he(a)}):te==null||te()});let ne=null;Me(()=>{t.type==="textarea"?ne=ge(T,e=>{var n;!Array.isArray(e)&&e!==le&&((n=i.value)===null||n===void 0||n.syncUnifiedContainer())}):ne==null||ne()}),Mn(Re,{mergedValueRef:T,maxlengthRef:Ve,mergedClsPrefixRef:c,countGraphemesRef:me(t,"countGraphemes")});const Pt={wrapperElRef:d,inputElRef:m,textareaElRef:o,isCompositing:D,clear:we,focus:xe,blur:mt,select:gt,deactivate:yt,activate:bt,scrollTo:wt},St=zn("Input",x,c),Pe=_(()=>{const{value:e}=ie,{common:{cubicBezierEaseInOut:n},self:{color:a,borderRadius:h,textColor:g,caretColor:u,caretColorError:B,caretColorWarning:E,textDecorationColor:W,border:U,borderDisabled:K,borderHover:fe,borderFocus:Mt,placeholderColor:zt,placeholderColorDisabled:Ft,lineHeightTextarea:At,colorDisabled:Tt,colorFocus:kt,textColorDisabled:_t,boxShadowFocus:Dt,iconSize:Rt,colorFocusWarning:Bt,boxShadowFocusWarning:Et,borderWarning:Wt,borderFocusWarning:$t,borderHoverWarning:It,colorFocusError:Lt,boxShadowFocusError:Vt,borderError:Nt,borderFocusError:Ot,borderHoverError:jt,clearSize:Ht,clearColor:Ut,clearColorHover:Kt,clearColorPressed:qt,iconColor:Yt,iconColorDisabled:Xt,suffixTextColor:Jt,countTextColor:Zt,countTextColorDisabled:Gt,iconColorHover:Qt,iconColorPressed:en,loadingColor:tn,loadingColorError:nn,loadingColorWarning:on,fontWeight:rn,[pe("padding",e)]:an,[pe("fontSize",e)]:ln,[pe("height",e)]:sn}}=f.value,{left:cn,right:dn}=Fn(an);return{"--n-bezier":n,"--n-count-text-color":Zt,"--n-count-text-color-disabled":Gt,"--n-color":a,"--n-font-size":ln,"--n-font-weight":rn,"--n-border-radius":h,"--n-height":sn,"--n-padding-left":cn,"--n-padding-right":dn,"--n-text-color":g,"--n-caret-color":u,"--n-text-decoration-color":W,"--n-border":U,"--n-border-disabled":K,"--n-border-hover":fe,"--n-border-focus":Mt,"--n-placeholder-color":zt,"--n-placeholder-color-disabled":Ft,"--n-icon-size":Rt,"--n-line-height-textarea":At,"--n-color-disabled":Tt,"--n-color-focus":kt,"--n-text-color-disabled":_t,"--n-box-shadow-focus":Dt,"--n-loading-color":tn,"--n-caret-color-warning":E,"--n-color-focus-warning":Bt,"--n-box-shadow-focus-warning":Et,"--n-border-warning":Wt,"--n-border-focus-warning":$t,"--n-border-hover-warning":It,"--n-loading-color-warning":on,"--n-caret-color-error":B,"--n-color-focus-error":Lt,"--n-box-shadow-focus-error":Vt,"--n-border-error":Nt,"--n-border-focus-error":Ot,"--n-border-hover-error":jt,"--n-loading-color-error":nn,"--n-clear-color":Ut,"--n-clear-size":Ht,"--n-clear-color-hover":Kt,"--n-clear-color-pressed":qt,"--n-icon-color":Yt,"--n-icon-color-hover":Qt,"--n-icon-color-pressed":en,"--n-icon-color-disabled":Xt,"--n-suffix-text-color":Jt}}),V=v?An("input",_(()=>{const{value:e}=ie;return e[0]}),Pe,t):void 0;return Object.assign(Object.assign({},Pt),{wrapperElRef:d,inputElRef:m,inputMirrorElRef:R,inputEl2Ref:M,textareaElRef:o,textareaMirrorElRef:w,textareaScrollbarInstRef:i,rtlEnabled:St,uncontrolledValue:C,mergedValue:T,passwordVisible:H,mergedPlaceholder:se,showPlaceholder1:Ee,showPlaceholder2:We,mergedFocus:ce,isComposing:D,activated:j,showClearButton:$e,mergedSize:ie,mergedDisabled:I,textDecorationStyle:Ie,mergedClsPrefix:c,mergedBordered:s,mergedShowPasswordOn:de,placeholderStyle:Ce,mergedStatus:Be,textAreaScrollContainerWidth:ye,handleTextAreaScroll:Ct,handleCompositionStart:Ge,handleCompositionEnd:Qe,handleInput:Q,handleInputBlur:tt,handleInputFocus:nt,handleWrapperBlur:ot,handleWrapperFocus:rt,handleMouseEnter:ct,handleMouseLeave:dt,handleMouseDown:st,handleChange:at,handleClick:it,handleClear:lt,handlePasswordToggleClick:ut,handlePasswordToggleMousedown:ht,handleWrapperKeydown:vt,handleWrapperKeyup:ft,handleTextAreaMirrorResize:xt,getTextareaScrollContainer:()=>o.value,mergedTheme:f,cssVars:v?void 0:Pe,themeClass:V==null?void 0:V.themeClass,onRender:V==null?void 0:V.onRender})},render(){var t,c,s,v,x,f,d;const{mergedClsPrefix:o,mergedStatus:w,themeClass:R,type:m,countGraphemes:M,onRender:z}=this,b=this.$slots;return z==null||z(),r("div",{ref:"wrapperElRef",class:[`${o}-input`,R,w&&`${o}-input--${w}-status`,{[`${o}-input--rtl`]:this.rtlEnabled,[`${o}-input--disabled`]:this.mergedDisabled,[`${o}-input--textarea`]:m==="textarea",[`${o}-input--resizable`]:this.resizable&&!this.autosize,[`${o}-input--autosize`]:this.autosize,[`${o}-input--round`]:this.round&&m!=="textarea",[`${o}-input--pair`]:this.pair,[`${o}-input--focus`]:this.mergedFocus,[`${o}-input--stateful`]:this.stateful}],style:this.cssVars,tabindex:!this.mergedDisabled&&this.passivelyActivated&&!this.activated?0:void 0,onFocus:this.handleWrapperFocus,onBlur:this.handleWrapperBlur,onClick:this.handleClick,onMousedown:this.handleMouseDown,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd,onKeyup:this.handleWrapperKeyup,onKeydown:this.handleWrapperKeydown},r("div",{class:`${o}-input-wrapper`},oe(b.prefix,i=>i&&r("div",{class:`${o}-input__prefix`},i)),m==="textarea"?r(Tn,{ref:"textareaScrollbarInstRef",class:`${o}-input__textarea`,container:this.getTextareaScrollContainer,theme:(c=(t=this.theme)===null||t===void 0?void 0:t.peers)===null||c===void 0?void 0:c.Scrollbar,themeOverrides:(v=(s=this.themeOverrides)===null||s===void 0?void 0:s.peers)===null||v===void 0?void 0:v.Scrollbar,triggerDisplayManually:!0,useUnifiedContainer:!0,internalHoistYRail:!0},{default:()=>{var i,p;const{textAreaScrollContainerWidth:C}=this,A={width:this.autosize&&C&&`${C}px`};return r(kn,null,r("textarea",Object.assign({},this.inputProps,{ref:"textareaElRef",class:[`${o}-input__textarea-el`,(i=this.inputProps)===null||i===void 0?void 0:i.class],autofocus:this.autofocus,rows:Number(this.rows),placeholder:this.placeholder,value:this.mergedValue,disabled:this.mergedDisabled,maxlength:M?void 0:this.maxlength,minlength:M?void 0:this.minlength,readonly:this.readonly,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,style:[this.textDecorationStyle[0],(p=this.inputProps)===null||p===void 0?void 0:p.style,A],onBlur:this.handleInputBlur,onFocus:T=>{this.handleInputFocus(T,2)},onInput:this.handleInput,onChange:this.handleChange,onScroll:this.handleTextAreaScroll})),this.showPlaceholder1?r("div",{class:`${o}-input__placeholder`,style:[this.placeholderStyle,A],key:"placeholder"},this.mergedPlaceholder[0]):null,this.autosize?r(_n,{onResize:this.handleTextAreaMirrorResize},{default:()=>r("div",{ref:"textareaMirrorElRef",class:`${o}-input__textarea-mirror`,key:"mirror"})}):null)}}):r("div",{class:`${o}-input__input`},r("input",Object.assign({type:m==="password"&&this.mergedShowPasswordOn&&this.passwordVisible?"text":m},this.inputProps,{ref:"inputElRef",class:[`${o}-input__input-el`,(x=this.inputProps)===null||x===void 0?void 0:x.class],style:[this.textDecorationStyle[0],(f=this.inputProps)===null||f===void 0?void 0:f.style],tabindex:this.passivelyActivated&&!this.activated?-1:(d=this.inputProps)===null||d===void 0?void 0:d.tabindex,placeholder:this.mergedPlaceholder[0],disabled:this.mergedDisabled,maxlength:M?void 0:this.maxlength,minlength:M?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[0]:this.mergedValue,readonly:this.readonly,autofocus:this.autofocus,size:this.attrSize,onBlur:this.handleInputBlur,onFocus:i=>{this.handleInputFocus(i,0)},onInput:i=>{this.handleInput(i,0)},onChange:i=>{this.handleChange(i,0)}})),this.showPlaceholder1?r("div",{class:`${o}-input__placeholder`},r("span",null,this.mergedPlaceholder[0])):null,this.autosize?r("div",{class:`${o}-input__input-mirror`,key:"mirror",ref:"inputMirrorElRef"}," "):null),!this.pair&&oe(b.suffix,i=>i||this.clearable||this.showCount||this.mergedShowPasswordOn||this.loading!==void 0?r("div",{class:`${o}-input__suffix`},[oe(b["clear-icon-placeholder"],p=>(this.clearable||p)&&r(be,{clsPrefix:o,show:this.showClearButton,onClear:this.handleClear},{placeholder:()=>p,icon:()=>{var C,A;return(A=(C=this.$slots)["clear-icon"])===null||A===void 0?void 0:A.call(C)}})),this.internalLoadingBeforeSuffix?null:i,this.loading!==void 0?r(wo,{clsPrefix:o,loading:this.loading,showArrow:!1,showClear:!1,style:this.cssVars}):null,this.internalLoadingBeforeSuffix?i:null,this.showCount&&this.type!=="textarea"?r(Te,null,{default:p=>{var C;const{renderCount:A}=this;return A?A(p):(C=b.count)===null||C===void 0?void 0:C.call(b,p)}}):null,this.mergedShowPasswordOn&&this.type==="password"?r("div",{class:`${o}-input__eye`,onMousedown:this.handlePasswordToggleMousedown,onClick:this.handlePasswordToggleClick},this.passwordVisible?J(b["password-visible-icon"],()=>[r(ae,{clsPrefix:o},{default:()=>r(go,null)})]):J(b["password-invisible-icon"],()=>[r(ae,{clsPrefix:o},{default:()=>r(bo,null)})])):null]):null)),this.pair?r("span",{class:`${o}-input__separator`},J(b.separator,()=>[this.separator])):null,this.pair?r("div",{class:`${o}-input-wrapper`},r("div",{class:`${o}-input__input`},r("input",{ref:"inputEl2Ref",type:this.type,class:`${o}-input__input-el`,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[1],disabled:this.mergedDisabled,maxlength:M?void 0:this.maxlength,minlength:M?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[1]:void 0,readonly:this.readonly,style:this.textDecorationStyle[1],onBlur:this.handleInputBlur,onFocus:i=>{this.handleInputFocus(i,1)},onInput:i=>{this.handleInput(i,1)},onChange:i=>{this.handleChange(i,1)}}),this.showPlaceholder2?r("div",{class:`${o}-input__placeholder`},r("span",null,this.mergedPlaceholder[1])):null),oe(b.suffix,i=>(this.clearable||i)&&r("div",{class:`${o}-input__suffix`},[this.clearable&&r(be,{clsPrefix:o,show:this.showClearButton,onClear:this.handleClear},{icon:()=>{var p;return(p=b["clear-icon"])===null||p===void 0?void 0:p.call(b)},placeholder:()=>{var p;return(p=b["clear-icon-placeholder"])===null||p===void 0?void 0:p.call(b)}}),i]))):null,this.mergedBordered?r("div",{class:`${o}-input__border`}):null,this.mergedBordered?r("div",{class:`${o}-input__state-border`}):null,this.showCount&&m==="textarea"?r(Te,null,{default:i=>{var p;const{renderCount:C}=this;return C?C(i):(p=b.count)===null||p===void 0?void 0:p.call(b,i)}}):null)}});export{po as C,Fo as N,wo as a,uo as e,vo as u};
