...
`,[C("scrollbar",`
 ...
 `)]),ee("render-label",`
 color: var(--n-text-color);
 `)]),ot("disabled",[J("&:hover",[ee("state-border",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>K(`${e}-status`,[ee("state-border",`border: var(--n-border-${e});`),ot("disabled",[J("&:hover",[ee("state-border",`
 ...
 `,[K("show-label","line-height: var(--n-label-line-height);"),J("&:hover",[C("checkbox-box",[ee("border","border: var(--n-border-checked);")])]),J("&:focus:not(:active)",[C("checkbox-box",[ee("border",`
 border: var(--n-border-focus);
 box-shadow: var(--n-box-shadow-focus);
 ...
 opacity: 1;
 transform: scale(1);
 `)])])]),K("indeterminate",[C("checkbox-box",[C("checkbox-icon",[J(".check-icon",`
 opacity: 0;
 transform: scale(.5);
 `),J(".line-icon",`
 opacity: 1;
 transform: scale(1);
 `)])])]),K("checked, indeterminate",[J("&:focus:not(:active)",[C("checkbox-box",[ee("border",`
 ...
 `,[ee("border",{border:"var(--n-border-disabled-checked)"}),C("checkbox-icon",[J(".check-icon, .line-icon",{fill:"var(--n-check-mark-color-disabled-checked)"})])])]),C("checkbox-box",`
 background-color: var(--n-color-disabled);
 `,[ee("border",`
...
`,[C("pagination-prefix",`
 ...
 `)]),ot("disabled",[K("hover",Zn,Yn),J("&:hover",Zn,Yn),J("&:active",`
...
`,[ee("splitor",`
 ...
 `),ot("checked",{color:"var(--n-button-text-color-hover)"})]),K("focus",[J("&:not(:active)",[ee("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),K("checked",`
 ...
 display: flex;
 flex-direction: column;
 `),K("flex-height",[J(">",[C("data-table-wrapper",[J(">",[C("data-table-base-table",`
 display: flex;
 flex-direction: column;
 flex-grow: 1;
 ...
 box-sizing: border-box;
 `),K("striped","background-color: var(--n-merged-td-color-striped);",[C("data-table-td","background-color: var(--n-merged-td-color-striped);")]),ot("summary",[J("&:hover","background-color: var(--n-merged-td-color-hover);",[J(">",[C("data-table-td","background-color: var(--n-merged-td-color-hover);")])])])]),C("data-table-th",`
 padding: var(--n-th-padding);
 position: relative;
 text-align: start;
 box-sizing: border-box;
 ...
 overflow: hidden;
 `)]),C("data-table-base-table",[K("transition-disabled",[C("data-table-th",[J("&::after, &::before","transition: none;")]),C("data-table-td",[J("&::after, &::before","transition: none;")])])]),K("bottom-bordered",[C("data-table-td",[K("last-row",`
 border-bottom: 1px solid var(--n-merged-border-color);
 `)])]),C("data-table-table",`
